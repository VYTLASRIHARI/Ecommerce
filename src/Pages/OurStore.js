         ...
         < div className="row">
            <div className="col-3">
              ...
              <div className='filter-card mb-3'>
                ...
                <div>
                  <h5 className='sub-title'>Availbulity</h5>
              ...
              <div className='filter-card mb-3'>
                ...
                <div>
                  <div className="random-products mb-3 d-flex gap-20">
                     <div className="w-50">
                      <img 
                   ...
                   <div className="random-products d-flex gap-20 ">
                     <div className="w-50">
                      <img 
            ...
            <div className="col-9">
              <div className="filter-sort-grid mb-4">
                <div className="d-flex justify-content-between align-items-center bgap-10">
                 ...
                 Sort By:
                  ...
                  <select 
                    ...
                    >
                      ...
                      <option value='title-asending' >
                         Alphbetically, A-Z
                      </option>
                      <option value='title-desending'>
                      Alphbetically, Z-A
                      </option>
                      <option value='price-asending'>
                        Price, low to high
                      </option>
                      <option value='price-desending'>
                         Price, high  to low
                      </option>
                      <option value='created-asending'>
                         Date, old to new
                      </option>
                      <option value='created-desending'>
                         Date, new to old
                      </option>
                   </select>
                </div>
